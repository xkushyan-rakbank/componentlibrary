...
const palette = {
  light: {
    ...COMMON,
    mode: 'light',
    text: { primary: GREY[900], secondary: GREY[700], tertiary: Danger[500], disabled: GREY[500] },
    background: {
      paper: White[100],
      default: White[100],
      secondary: GREY[100],
  ...
  dark: {
    ...COMMON,
    mode: 'dark',
    text: { primary: White[100], secondary: GREY[500], tertiary: Danger[500], disabled: GREY[600] },
    background: {
      paper: Primary[900],
      default: GREY[900],
      secondary: GREY[800],
